...
function initializeApp() {
    // --- ZMIENNE W ZASIĘGU INICJALIZACJI ---
    ...
    // ==========================================================================
    // WSZYSTKIE FUNKCJE POMOCNICZE I RENDERUJĄCE SĄ TERAZ WEWNĄTRZ initializeApp
    // ==========================================================================
    ...
    async function updateUIBasedOnAuthState(user: User | null) {
        ...
        try {
            ...
            if(mainAppContent) mainAppContent.innerHTML = `<div class="alert alert-danger">Wystąpił krytyczny błąd.</div>`;
        }
    }
